...
Everthing below is copied from Session 14
...
```{r echo=TRUE}
set.seed(228)
E <- rnorm(n=500, mean=0, sd=10) #unit-level variability
...
population <- declare_population(
  ...
  customers = add_level(N=10000, 
    # unit for water_saved is million gallons
    water_saved=runif(n=N, min=10, max=100),
## STOPPED HERE
...
```{r}
# n = 100
# design_label	estimator_label	bias	power	coverage
# design	DID	-0.0121972	0.484	0.952
# design	DIM	-0.0725616	0.066	0.964

# n = 200
# design_label	estimator_label	bias	power	coverage
# design	DID	-0.0033316	0.740	0.942
# design	DIM	-0.0072392	0.068	0.958
```
